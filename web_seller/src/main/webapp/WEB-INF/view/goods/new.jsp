...
<table width="100%" cellpadding="0" cellspacing="8" class="add_tab tr td">
	...
	<tr>
		...
		<td width="85%">
			...
			<ul id="membercatList" style="padding-top:5px;"></ul>
			<input type="hidden" name="membercat" id="membercat" value="" />
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<sf:textarea path="goodsDetail" id="goodsDetail" maxlength="30000"/>
		</td>
	</tr>
				...
				for(var j=0;j<cat_s.length;j++)
				{
					if(cat_s[j]!="")
					{
						...
						if(j==0)
						{
        					...
        					//membercatSelect.options.add(varItem); ie8:bug
