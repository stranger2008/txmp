                ...
                <tr class="tab_td">
                				...
                				<tr>
                					<td style="border:0px; width:100px;">
                						<c:if test="${!empty orderdetail.img_path}">
			                        		<img src="<h:imgSubstr imgpath="${orderdetail.img_path}"/>"/>
			                       		</c:if>
                					</td>
                					<td style="border:0px;">
                	...
                	<td>
                		...
                		<c:if test="${item.order_state==1}">
                			<button class="tab_btnlist" type="button" onclick="location.href='<%=basePath%>order/detail-${item.order_id}.action#001';"/>发货</button>
                		</c:if>
                	</td>
