...
public class PublicController extends BaseController{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="public/showSelectLink",method=RequestMethod.GET, produces = "text/html;charset=UTF-8")
	@ResponseBody
	public String getShowSelectLink(String model_name,String up_model_id ) throws Exception {
		String module_type = this.getRequest().getParameter("module_type");
		String resutlStr = "";
		model_name = model_name==null?"category":model_name;
		if(model_name!=null && model_name.equals("area") && !up_model_id.trim().equals(""))
		{
			List list = areaService.getAreaListByUpareaid(up_model_id);
			resutlStr = getOptionStrByList(list,"area_id","area_name");
		}
		else if(model_name!=null && model_name.equals("category") && !up_model_id.trim().equals(""))
		{
			List list = categoryService.getCategoryByUpCatId(up_model_id ,module_type);
	...
	public String error(String name,ModelMap model){
