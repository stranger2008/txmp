...
<title>资金列表</title>
<style type="text/css">
.pathdiv{margin: 0 0 10px 0;border-bottom: 1px solid #cccccc; padding: 10px 0;}
</style>
...
<sf:form action="fundaccount/memberuser-index.action" id="queryForm" modelAttribute="fundaccountQueryForm">
<div class="searchdiv">
	<ul>
