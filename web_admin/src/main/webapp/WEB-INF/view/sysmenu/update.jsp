...
<div class="position">修改菜单</div>

<sf:form method="post" action="sysmenu/update.action" modelAttribute="sysmenu">
...
<table width="100%" cellpadding="0" cellspacing="8" class="add_tab tr td">
	...
	<tr><td class="addtab_tit"></td><td><sf:errors path="up_menu_id" cssClass="error"/></td></tr>
