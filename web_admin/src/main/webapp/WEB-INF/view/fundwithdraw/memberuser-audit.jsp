...
<html>
<head>
<title>个人资金提现审批</title>
<%@ include file="/WEB-INF/view/inc/inc.jsp" %>
</head>
<body>

<div class="position">个人资金提现审批</div>

<sf:form method="post" id="memberuser_audit_form" action="fundwithdraw/memberuser-audit.action" modelAttribute="fundwithdraw">
...
<table width="100%" cellpadding="0" cellspacing="8" class="add_tab tr td">
	...
	<tr>
		<td class="addtab_tit">会员名称<span>&nbsp;</span></td>
		<td>
	...
	<tr>
		...
		<td>
			...
			<sf:radiobutton path="status" value="1" />不通过
		</td>
	</tr>
	<tr><td class="addtab_tit"></td><td><sf:errors path="status" cssClass="error"/></td></tr>
	...
	<tr>
		...
		<td>
			...
			<button class="tab_btn" type="button" onclick="if(document.getElementById('times').value!=0) return; document.getElementById('times').value=1; this.style.background='#666666'; document.getElementById('memberuser_audit_form').submit();"/>提交</button>
		</td>
	</tr>
</table>
