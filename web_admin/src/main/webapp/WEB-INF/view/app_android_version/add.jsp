...
<div class="position">添加手机端版本</div>

<sf:form method="post" action="app_android_version/add.action" modelAttribute="app_android_version">

<table width="100%" cellpadding="0" cellspacing="8" class="add_tab tr td">

	
	<tr>
		<td class="addtab_tit">版本编号<span>*</span></td>
		<td>
