...
<div class="position">添加商品品牌</div>

<sf:form method="post" action="goodsbrand/add.action" modelAttribute="goodsbrand">
...
<table width="100%" cellpadding="0" cellspacing="8" class="add_tab tr td">
	...
	<tr>
		...
		<td>
			<sf:radiobutton path="is_recom" value="1" />是 &nbsp;&nbsp;&nbsp;&nbsp;
            <sf:radiobutton path="is_recom" value="0" checked="true"/>否
		</td>
	</tr>
