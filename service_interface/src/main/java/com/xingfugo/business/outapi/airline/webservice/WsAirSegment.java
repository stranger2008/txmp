...
/**
 * <p>
 * Java class for wsAirSegment complex type.
 * 
 * <p>
...
@XmlType(name = "wsAirSegment", propOrder = { "arrCode", "arrTime", "depCode",
		"depDate", "depTime", "flightNo", "param1", "param2", "param3",
		"param4", "planeModel", "seatClass" })
