package com.xingfugo.business.outapi.unionpay.service;

import java.util.Map;

import com.xingfugo.business.outapi.unionpay.conf.UpmpConfig;
import com.xingfugo.business.outapi.unionpay.util.HttpUtil;
import com.xingfugo.business.outapi.unionpay.util.UpmpCore;
...
public class UpmpService{
	 ...
	 * @return 是否成功
	 */
	public static String trade(Map<String, String> req, Map<String, String> resp) {
		String nvp = buildReq(req);
		System.out.println("请求报文===================================："+nvp);
		String rqResult =HttpUtil.post(UpmpConfig.TRADE_URL, nvp);
		System.out.println("请求报文===================================："+rqResult);
		return rqResult;
