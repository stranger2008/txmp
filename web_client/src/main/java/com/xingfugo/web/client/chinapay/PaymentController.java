package com.xingfugo.web.client.chinapay;
...
import com.xingfugo.web.client.controller.BaseController;
...
public class PaymentController extends BaseController{
	...
	public String payment(String order_id,ModelMap model){
	  ...
	  //根目录
	    String rootPath = this.getRequest().getRequestURL().toString().replace("order/payment.action", "");
	    
		String BgRetUrl = rootPath + "orderOkNotifyUrl.action";
		String PageRetUrl = rootPath + "user/orderlist.action";
		
		//银联支付信息
		String requestPath = this.getRequest().getContextPath();
		System.out.println(requestPath);
		Map<String,String> payMap =  PayUtil.getPayMap(TransAmt, order_id, PayUtil.getClientIp(this.getRequest()), BgRetUrl, PageRetUrl);
	...
	public String rechargePayment(String order_no,ModelMap model){
	    ...
	    //返回页面url
	    String PageRetUrl = rootPath + "fundaccount/balance.action";
