...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    $(function(){
        ...
        $('.brand-canel').click(function(){
         ...
         $('.brand-ok').click(function(){
			...
			location.href = "<%=basePath%>searchGoods.action?"+fromdate;
         });
	...
	<body>
		...
		<sf:form action="searchGoods.action" id="goodsqueryForm" modelAttribute="goodsQueryForm">
		 ...
		 function deleteSearch(index){
           ...
           function searchGoodsByPrice(){
           		...
           		if(minPrice.length>0&&maxPrice.length>0){
           			location.href="<%=basePath%>searchGoods.action?cat_id=${goodsQueryForm.cat_id}&maxPrice="+maxPrice+"&minPrice="+minPrice;
           		}else{
           			alert("请输入查询价格!");
           		}
           }
