		...
		<div class="module">
		    <section>
		    	<div class="download-bg margin-center">
					...
					<div class="app-btns">
		            	<span class="android-btn"><a href="<%=basePath %>inc/XingFuGo_0813.apk" target="_blank"><span class="app-icon1"></span><span>下载</span><span>Android 版本</span></a></span>
		                <p class="app-txt">适用于2.2以上版本</p>
		            	<span class="app-btn"><a href="###"><span class="app-icon2"></span><span>下载</span><span>IOS 版本</span></a></span>
