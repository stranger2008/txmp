...
<sf:form method="post" id="dataForm" action="member/joinus-step2.action" modelAttribute="member">
<div class="seller">
		...
		<div class="seller-cont">
			...
			<ul class="seller-c-list">
				...
				<li>
					...
					<em class="a-lan">联系人姓名，用于今后查询入驻进度</em>
				</li>
				<li>
					<label>
						<span>*</span>联系人电话：
				...
				<li>
					...
					<em class="a-lan">请填写真实电话，用于今后查询入驻进度</em>
				</li>
				<li>
					<label>
						<span>*</span>联系人电子邮箱：
					...
					<sf:errors path="contact_email" cssClass="error"/>
				</li>
				<li>
					<label></label>
