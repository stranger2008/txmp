				...
				<sf:form method="post" action="user/addrinsert.action" modelAttribute="buyeraddr">
				    <div class="account-add-site" style="padding-top:10px;">
				        <ul>
				            <li>
				                <span>*</span>&nbsp;&nbsp;收货人：
				                <sf:input path="cust_name" maxlength="20"/><em><sf:errors path="cust_name" cssClass="error"/></em>
				            </li>
				            <li>
				                <span>*</span>所在地区：
				            ...
				            <li>
				                <span>*</span>详细地址：
				                <sf:input path="address" style="width:350px;" maxlength="50"/><em><sf:errors path="address" cssClass="error"/></em>
				            </li>
				            <li>
				                <span>*</span>手机号码：
				            ...
				            <li class="li_is_default">
				                ...
				                <input name="is_default" id="is_default" type="hidden" value="0"/>
				            </li>
				            <li>
				                <button type="submit" style="padding:3px 15px;margin:20px 0 30px 80px;"/>保存收货地址</button>
				            </li>
				        </ul>
				    </div>
				</sf:form>
