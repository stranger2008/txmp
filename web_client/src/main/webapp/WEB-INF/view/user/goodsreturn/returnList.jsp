...
<div class="w1200">
	<div class="usercenter">
		...
		<sf:form action="user/goodsReturn_look.action" id="returnQueryForm" modelAttribute="goodsreturnQueryForm">
        ...
        <div class="user-info fr">
            ...
            <div class="store">
                ...
                <div class="store-tab">
                    ...
                    <a class="active" href="<%=basePath %>user/goodsReturn_look.action">查看返修/退换货记录<span></span></a>
                    <a href="<%=basePath %>user/goodsReturnMoney_look.action">查看退款记录<span></span></a>
                </div>
                <p style="float: right;margin: 10px 15px 0 0;">
                    <sf:input path="keywords" cssClass="my-o-s-input" placeholder="商品名称、订单编号" title="商品名称、订单编号" />
                ...
                <div class="store-list" id="store-show">
                    ...
                    <div>
                        <table width="100%" border="0" class="account-repair-head" cellpadding="5" cellspacing="0">
                            <tr bgcolor="#f5f5f5">
                                <td width="120" align="center">返修/退换货编号</td>
                                <td width="120" align="center">订单编号</td>
                                <td align="center">商品名称</td>
                                <td width="130" align="center">
                                    <sf:select path="sear_days" onchange="$('#returnQueryForm').submit();" >
										<sf:option value="">申请时间</sf:option>
										<sf:options items="${seardaysMap}"></sf:options>
									</sf:select>
                                </td>
                                <td width="130" align="center">
                                    <sf:select path="info_state" onchange="$('#returnQueryForm').submit();" >
										<sf:option value="">全部状态</sf:option>
										<sf:options items="${infoStateMap }"></sf:options>
									</sf:select>
                                </td>
                           ...
                           <c:forEach items="${pageResult.list}" var="item">
                            <tr>
                                ...
                                <td width="110" align="center">
                                    <a href="<%=basePath%>user/goodsReturn_prolist.action?trade_id=${item.trade_id }">查看</a><br/>
                                    <c:if test="${item.biz_type==1}">
                                    <a href="<%=basePath %>user/goodsReturnMoney_look.action?trade_id=${item.trade_id }">退款明细</a>
                                    </c:if>
                                </td>
                            </tr>
                           </c:forEach>
