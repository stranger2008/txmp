...
<div class="module">
    <section>
    	<div class="cont mt5">
            ...
            <div class="rece-info">
            	<a href="<%=basePath %>order/confirm_address.action">
            ...
            <div class="rece-info">
            	<a href="<%=basePath %>order/confirm_invoice.action">
            ...
            <div><input type="button" class="sign_btn mgn" onclick="window.location.href='<%=basePath %>order/confirm_order_ok.action';" value="提交订单" /></div>
        </div>
    </section>
</div>
