...
<html>
	<head>
		...
		<meta name="description" content="天下名品彩票">
...
<body>
	<style type="text/css">
	    ...
	    .new-m-myjd span,.new-m-cart span{display:inline-block;width:26px;height:21px;margin-top:13px;background:url(http://m.jd.com/images/touch2013/icon2b.png) 4px 0 no-repeat;background-size:180px 180px;text-indent:-9999px}
	    ...
	    .new-a-back2{background:url(http://m.jd.com/images/touch2013/icon.png) no-repeat scroll 3px -1431px;height: 32px;left: 6px;position: absolute;text-indent: -9999px;top: 6px;width: 30px}
	...
	<div class="new-header new-header-append">
		<a href="<%=basePath%>lottery/lotteryInfo.action?gameid=3" class="new-a-back"><span>返回</span></a>
				<h2>确认投注</h2>
...
<form id="baseForm" action="<%=basePath %>lottery/doubleChromosphereorderInfo.action" method="get">
	<input type="hidden" name="sid" value="37ead48552a86aac5f42836aafd117bd">
	<input type="hidden" name="lotteryCategory" value="1" id="lotteryCategory">
	<input type="hidden" name="canSell" value="1" id="canSell">
	<input type="hidden" name="addByUserHref" value="<%=basePath %>/lottery/lotteryInfo.action?gameid=3" id="addByUserHref">
	...
	<div class="new-ct kuai3">
		<div class="order-list">
			<!--号码区-->
			<div id="numberInfo"><div class="new-tbl-type" id="numberrow2"><div class="new-tbl-cell w80"><div class="choose-box"><div class="choose-num"><span style="padding-right:0px;">07 12 17 18 24 26 </span><span style="color:#00f;padding-right:0px;">11 15</span></div><div class="total"><span>复式投注</span><span class="new-fr">2注 4元</span></div></div></div><div class="new-tbl-cell"><a href="javascript:void(0);" onclick="deleteRow(2)" class="btn-del">删除</a></div></div><div class="new-tbl-type" id="numberrow1"><div class="new-tbl-cell w80"><div class="choose-box"><div class="choose-num"><span style="padding-right:0px;">06 07 08 10 28 32 </span><span style="color:#00f;padding-right:0px;">07</span></div><div class="total"><span>标准投注</span><span class="new-fr">1注 2元</span></div></div></div><div class="new-tbl-cell"><a href="javascript:void(0);" onclick="deleteRow(1)" class="btn-del">删除</a></div></div></div>
	</div>
	<!--功能区1-->
		<div class="option-area2">
        	...
        	<div class="check-area new-tbl-type">  </div>
            <div class="btn-tbl">
		...
		<a name="touzhu"></a>
		<!--功能区2-->
        <div class="pay-total"><!--3-->
        	<div id="payTotal">总金额:<span class="new-txt-rd2">6元</span><span class="new-fr">3注1期1倍</span></div>
	...
	<div class="pop" style="display:none;height:85px" id="confirmPop">
		<span id="confirmPopHtml"></span>
	    <div class="new-tbl-type">
	    <span class="new-tbl-cell">
	    	<a href="javascript:void(0);" class="btn-type6" id="confirmPopBqButton">取消</a>
	    </span>
	    <span class="new-tbl-cell">
	    	<a href="javascript:void(0);" class="btn-type2" id="confirmPopTzButton">确认</a>
	    </span>
    </div>
	</div>
...
function showHead(sid,title,link,version,type){
...
function showFoot(sid,title,link,version,type){
        var param = new Object();
...
$(function(){
    		 showHead('37ead48552a86aac5f42836aafd117bd', '确认投注'   , '/pick/pick?pickType=1&sid=37ead48552a86aac5f42836aafd117bd'  );
			showFoot('37ead48552a86aac5f42836aafd117bd');
	});
</script>
...
<style type="text/css">
	...
	.new-banner-img,.new-banner-img2{width:320px;height:61px;margin:0 auto;background:url(<%=basePath %>inc/outapi/lottery/images/banner_footer.gif);background-color:#fff}
	.new-banner-img2{background:url(<%=basePath %>inc/outapi/lottery/images/banner_footer.gif)}
	.new-banner-img3{width:320px;height:61px;margin:0 auto;background:url(<%=basePath %>inc/outapi/lottery/images/banner_footer.gif) 0 0 no-repeat;background-color:#fff}
