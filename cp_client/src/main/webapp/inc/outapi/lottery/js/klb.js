(function(e) {
    ...
    n.mobile.selectCodeInit = function() {
        ...
        p.on({
            click: function() {
                ...
                i = t(".pick").eq(n.mobile.LOT_METHOD).find("ul"); ! r || i.find(".selected").length > 0 || n.mobile.LOT_METHOD === 1 ? n.mobile.pickBall(t(this)) : e.location.href = "/xfg_cp_client/lottery/klborder.action"
            },
            touchstart: function() {
    ...
    n.mobile.pickBall = function(r) {
        ...
        a == "addcart" ? (t("#group").text(n.mobile.cart.group), n.mobile.clearAll()) : e.location.href = "/lottery/klborder.action"
    },
    ...
    n.mobile.AsynDownData = function() {
        ...
        o = t("#countdowm"),
        u = t("#qlchistory");
        i.html('快乐8-<cite id="game">\u81ea\u9009</cite><span class="head-arr"><em></em></span>');
